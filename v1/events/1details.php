...
if ($registration == "Group") {
 echo '<a class="btn btn-success" data-toggle="modal" href="#myModal">Launch Modal</a>
';
}
 elseif ($registration == "Individual") {
	echo '
<form action="register.php" name="register" method="post">
 <input type="hidden" name="txtcount" id="txtcount" value="'.$row['count']; $counter = $row['count'].'">
 <input type="hidden" name="txtaid" id="txtaid" value="'.$_SESSION['member_id'].'">
  <input type="hidden" name="txteid" id="txteid" value="'.$row['id'];$regID=$row['id'].'">
