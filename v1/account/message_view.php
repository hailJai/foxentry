...
$objQuery = mysql_query($strSQL);  
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_messages WHERE receiver = '".$_SESSION['member_id']."' and mID = '".$id."'  ORDER BY date DESC, time DESC");
...
<div class="title"><a href="messages.php">Personal Messages</a></div>
<div class="from">
...
<form action="../csc/send.php" name="frmAdd" method="post" onSubmit='return validate();'>
<?php date_default_timezone_set("Asia/Singapore");  ?>
<!-- predef forms -->
<input name="txtType" type="hidden" id="txtType" value="reply" />
<input name="txtSub" type="hidden" id="txtSub" value="Bullying Report" />
