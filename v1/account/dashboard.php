...
while($row = mysql_fetch_array($result))
{
    ...
    <div class='postcontainer' style='background-color:#fff; box-shadow: 0px 0px 5px #C0C0C0;'>
...
<div style="width:170px; display: inline-block; background-color:#999; vertical-align:top; margin-top:10px" id="crossfadegt">
	<a href="<?php echo linkad($url); ?>" target="_top"><img src="<?php echo $url; ?>" class = "img1" width="220" height="auto" /></a>
</div>
</body>
</html>