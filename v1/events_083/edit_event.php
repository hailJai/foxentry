...
{	
  ...
  longdesc='$edit_ldesc', type='$edit_type', date='$edit_date', time='$edit_time', MAX='$edit_max', opento='$edit_open', display ='$edit_dp', cover='$edit_cover' WHERE id='".$event."'";
...
<td width="91" height="50">Max Participants</td>
  ...
  <tr>
    ...
    <td width="326"><input name="txtcover" type="text" class="forms" id="txtcover" value="<?php echo $row['cover'] ?>" size="20" /></td>
