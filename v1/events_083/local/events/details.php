...
<tr>
	...
	<td><div align="center">year lvl</div></td>	
</tr>
<tr>
	<td></td>
	<td></td>
...
$regis = mysqli_query($con,"SELECT fox_users.fname, fox_users.lname, fox_registrants.eID, fox_registrants.aID FROM fox_users INNER JOIN fox_registrants ON fox_users.uID = fox_registrants.aID WHERE eID='".$regID."' ");
