...
.thumbnails {
	...
	background-image:url(../images/thmbnail1.jpg);
...
<div class="container">
    ...
    <img src="../images/Calendar-icon.png" width="19" height="19" /> Events that you created</p>
    </div>
		...
		while($row3 = mysqli_fetch_array($result3))
  		{
			if($row3['aID'] == $_SESSION['member_id'])
			{
				...
				echo "	<div class='thumbnails'>
						...
						<a href=\"delete_events.php?id=".$row3['aID']."\">[X]</a>
	    				<a href=\"edit_event.php?id=".$row3['id']."\">[Edit]</a>
						</span>
						<a href='details.php?id=".$row3['id']."' >
      					<img src='../images/Science-icon.png' width='155' height='155' style='margin-top:5px' />
