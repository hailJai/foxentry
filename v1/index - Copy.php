      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <div class="TabbedPanelsContent">
          <ul id="MenuBar1" class="MenuBarVertical">
            ...
            <li><a href="index.php?p=nogame"><img src="images/Link-Building-Icon.png" width="17" height="17" /> No Game</a></li>
            <li><a href="index.php?p=nogame"><img src="images/contacts-icon.png" width="17" height="17" /> Download Activity Card</a></li>
          </ul>
        </div>
        <div class="TabbedPanelsContent">
          <ul id="MenuBar1" class="MenuBarVertical">
