      ...
      <div class="TabbedPanelsContentGroup">
        ...
        <div class="TabbedPanelsContent">
          <ul id="MenuBar1" class="MenuBarVertical">
            ...
            <li><a href="no-game" target="_parent"><img src="images/Link-Building-Icon.png" width="17" height="17" /> No Game</a></li>
            <li><a href="artrave" target="_parent"><img src="images/stickies-icon.png" width="17" height="17" /> Art Rave Online Voting</a></li>
            <li><a href="account/activity_card.php" target="_new"><img src="images/dictionary-icon.png" width="17" height="17" /> Print Activity Card</a></li>
          </ul>
        </div>
        <div class="TabbedPanelsContent">
          <ul id="MenuBar1" class="MenuBarVertical">
