...
<title>MASTER LIST OF MEMBERS | LOOP</title>
<style type="text/css">
body,td,th {
...
<p align="center">HOLY ANGEL UNIVERSITY<br />
  ...
  <span style="font-size:16px">LEAGUE OF OUTSTANDING PROGRAMMERS</span></p>
...
<table width="100%" border="1">
  <tr>
    ...
    <th>Amount</th>
		...
		include('../account/conn2.php');
		$result3 = mysqli_query($con,"SELECT * FROM fox_users WHERE organization = 'LOOP' ORDER BY payment");
		$i = 0;
