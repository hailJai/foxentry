...
<div class="container-main">
	<div class="title">Reports about professors</div>
	<div  id="messages">
    <ul>
  		<?php 
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_messages WHERE type = 'prof' ORDER BY date DESC, time DESC");
		while($row3 = mysqli_fetch_array($result3))
  		{
		echo "
		<li>
        <a href='prof_reports_view.php?id=".$row3['mID']."'>";
