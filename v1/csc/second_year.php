...
<title>MASTER LIST OF CMT Members</title>
<style type="text/css">
body,td,th {
...
<p align="center">MASTER LIST OF SECOND YEAR STUDENTS</p>
<table width="100%" border="1">
  <tr>
    ...
    <th>Email Address</th>
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_users WHERE yearlevel = 'Second' ORDER BY SECTION");
		$i = 0;
