...
$objQuery = mysql_query($strSQL);  
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_messages WHERE type = 'prof' and mID = '".$id."'");
...
<div class="title"><a href="prof_reports.php">Reports about professors</a></div>
<div class="from">
...
<input name="txtSub" type="hidden" id="txtSub" value="Report a Prof" />
