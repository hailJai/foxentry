...
<title>MASTER LIST OF FOURTH YEAR STUDENTS</title>
<style type="text/css">
body,td,th {
...
<p align="center">MASTER LIST OF FOURTH YEAR STUDENTS</p>
<table width="100%" border="1">
  <tr>
    ...
    <th>Email Address</th>
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_users WHERE yearlevel = 'Fourth Year' OR yearlevel = 'Fourth' ORDER BY SECTION");
		$i = 0;
