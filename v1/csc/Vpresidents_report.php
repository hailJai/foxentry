...
<title>MASTER LIST OF CLASS VICE PRESIDENTS</title>
<style type="text/css">
body,td,th {
...
<p align="center">MASTER LIST OF CLASS VICE PRESIDENTS</p>
<table width="100%" border="1">
  <tr>
    ...
    <th>Organization</th>
        ...
        <?php
		include('../account/conn2.php');
		$result3 = mysqli_query($con,"SELECT * FROM fox_users WHERE position LIKE '%CLASS VICE PRESIDENT%' ORDER BY section");
		$i = 0;
