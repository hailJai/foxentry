...
<table cellspacing="5px" cellpadding="3px">
  <tr>
    <td id="title" colspan="2">Have a suggestion to the Council? Write them here!</td>
    </tr>
  <tr>
    <td colspan="2">Through this form, you can send your suggestion directly to us. </td>
    </tr>
  <tr>
...
// EndOAWidget_Instance_2204022
  ...
  <tr>
    <td colspan="2">Note: Abuse of this form can lead to serious consequence.</td>
    </tr>
  <tr>
    <td width="62%"><input name="txtuID" type="hidden" value="<?php echo $_SESSION['member_id'];?>" />
      <input name="txtTid" type="hidden" id="txtTid" value="0" /></td>
    <td width="38%">&nbsp;</td>
  </tr>
  <tr>
    <td><input name="txtType" type="hidden" id="txtType" value="suggest" />
      <input name="txtSub" type="hidden" id="txtSub" value="Suggestion to the Council" /></td>
