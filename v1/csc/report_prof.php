...
<table cellspacing="5px" cellpadding="3px">
  <tr>
    <td id="title" colspan="2">Report a Professor</td>
    </tr>
  <tr>
    <td colspan="2">You can report here your professor either by not going into class or he/she does something not right to your or even to your friend. Please indicate his/her name so that we'll know how we can help you and also the date when the incident happened. Your indentity will not be disclosed to your professor.</td>
    </tr>
  <tr>
...
// EndOAWidget_Instance_2204022
      ...
      <textarea id="messagebody" name="messagebody" rows="16" style="width:100%">Name of the Professor: <br /> Date when the incident happened:</textarea></td>
    </tr>
  <tr>
  ...
  <tr>
    <td><input name="txtType" type="hidden" id="txtType" value="prof" />
      <input name="txtSub" type="hidden" id="txtSub" value="Report a Prof" /></td>
