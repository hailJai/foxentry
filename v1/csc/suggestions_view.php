...
$objQuery = mysql_query($strSQL);  
		...
		$result3 = mysqli_query($con,"SELECT * FROM fox_messages WHERE type = 'suggest' and mID = '".$id."'");
...
<div class="title"><a href="suggestions.php">Suggestions to the Student Council</a></div>
<div class="from">
...
<input name="txtSub" type="hidden" id="txtSub" value="Suggestion to the Student Council" />
